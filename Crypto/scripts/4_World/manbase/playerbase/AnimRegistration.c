modded class PlayerBase extends ManBase
{
        ...
        if ( !GetGame().IsServer() || !GetGame().IsMultiplayer() ) 
    {
		...
		GetDayZPlayerType().AddItemInHandsProfileIK("Cryptocurrency_Bag_base", "dz/anims/workspaces/player/player_main/props/player_main_1h_torch.asi", toolsOneHanded,        "dz/anims/anm/player/ik/gear/GasLight.anm");
    }
        super.Init();
    }
}